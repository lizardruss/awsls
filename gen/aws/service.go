...
// ResourceTypesForAWSServices returns the Terraform resource types for each AWS service.
// An AWS service is only part of the list it's resource type list is non-empty.
